...
int main(int argc, char* argv[]) {
	...
	try {
		...
		while (true) {
			...
			HT::Element* getElement = OS13_LIB::OS13_HTCOM::ConstructGetElement_HT(h, key, (int)strlen(key));

			HT::Element* retElement = OS13_LIB::OS13_HTCOM::Get_HT(h, storage, getElement);
			if (retElement == NULL) {
				...
				std::cout << "Retrieved:";
				OS13_LIB::OS13_HTCOM::Print_HT(h, retElement);
