...
class OS15 :public IHT {
public:
	virtual HRESULT __stdcall QueryInterface(REFIID riid, void** ppv);
	virtual ULONG __stdcall AddRef();
	virtual ULONG __stdcall Release();

	virtual HRESULT __stdcall COM_Create(HT::HTHANDLE** ppHandle, int Capacity, int SecSnapshotInterval, int MaxKeyLength, int MaxPayloadLength, const char UserGroup[512], const char FileName[512]);
	virtual HRESULT __stdcall COM_Open(HT::HTHANDLE** ppHandle, const char FileName[512]);
	virtual HRESULT __stdcall COM_Open(HT::HTHANDLE** ppHandle, const char User[256], const char Password[256], const char FileName[512]);
	...
	~OS15() {
		...
		std::cout << "OS15: Destroying COM component" << std::endl;
	}
private:
	volatile long m_ref;
};