...
void CMyProt2DDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMyProt2DDoc::InitializeSearchContent()
{
...
void CMyProt2DDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
