...
//ѕринимающа€ только строку rand и отвечающа€ случайным целым четырехбайтовым числом в intel-формате. 
//”словие завершение работы: прием любой последовательности символов, отличной от    rand.  
