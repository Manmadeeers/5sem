...
int wmain(void)
{
    ...
    WCHAR app1[MAX_PATH + 32];
    lstrcpyW(app1, exePath);
    lstrcatW(app1, L" 50");
    if (CreateProcessW(
        app1,
        NULL,
    ...
    {
        created[2] = TRUE;
        WriteFmt(L"[3] Created: ", exePath);
        WriteFmt(L"[3] CmdLine arg: ", cmd3Arg);
    }
    else
    {
